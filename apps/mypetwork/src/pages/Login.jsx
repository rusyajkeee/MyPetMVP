    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-work-dark via-work-primary to-work-light items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-12 max-w-lg">
          ...
          <h1 className="text-4xl font-extrabold mb-4">MyPetWork</h1>
          <p className="text-lg text-blue-100 leading-relaxed">
            Your professional dashboard to manage pet services, appointments, and grow your business.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-1">Sign in to MyPetWork</h2>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/register" className="font-medium text-work-primary hover:text-work-dark">
